...
func IsEnabled(v bool) predicate.User {
	return predicate.User(sql.FieldEQ(FieldIsEnabled, v))
}
...
func IsEnabledNEQ(v bool) predicate.User {
	return predicate.User(sql.FieldNEQ(FieldIsEnabled, v))
}
...
func HasBackendsWith(preds ...predicate.S3Backend) predicate.User {
	return predicate.User(func(s *sql.Selector) {
