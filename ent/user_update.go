...
func (_u *UserUpdate) SetIsEnabled(v bool) *UserUpdate {
	_u.mutation.SetIsEnabled(v)
	return _u
}

// SetNillableIsEnabled sets the "is_enabled" field if the given value is not nil.
func (_u *UserUpdate) SetNillableIsEnabled(v *bool) *UserUpdate {
	if v != nil {
		_u.SetIsEnabled(*v)
	}
	return _u
...
// AddBackends adds the "backends" edges to the S3Backend entity.
func (_u *UserUpdate) AddBackends(v ...*S3Backend) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearBackends clears all "backends" edges to the S3Backend entity.
func (_u *UserUpdate) ClearBackends() *UserUpdate {
	_u.mutation.ClearBackends()
	return _u
}

// RemoveBackendIDs removes the "backends" edge to S3Backend entities by IDs.
func (_u *UserUpdate) RemoveBackendIDs(ids ...int) *UserUpdate {
	_u.mutation.RemoveBackendIDs(ids...)
	return _u
}

// RemoveBackends removes "backends" edges to S3Backend entities.
func (_u *UserUpdate) RemoveBackends(v ...*S3Backend) *UserUpdate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *UserUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.BackendsCleared() {
		edge := &sqlgraph.EdgeSpec{
			...
			Columns: user.BackendsPrimaryKey,
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(s3backend.FieldID, field.TypeInt),
			},
		}
...
// SetIsEnabled sets the "is_enabled" field.
func (_u *UserUpdateOne) SetIsEnabled(v bool) *UserUpdateOne {
	_u.mutation.SetIsEnabled(v)
	return _u
}

// SetNillableIsEnabled sets the "is_enabled" field if the given value is not nil.
func (_u *UserUpdateOne) SetNillableIsEnabled(v *bool) *UserUpdateOne {
	if v != nil {
		_u.SetIsEnabled(*v)
	}
	return _u
...
// AddBackends adds the "backends" edges to the S3Backend entity.
func (_u *UserUpdateOne) AddBackends(v ...*S3Backend) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// RemoveBackends removes "backends" edges to S3Backend entities.
func (_u *UserUpdateOne) RemoveBackends(v ...*S3Backend) *UserUpdateOne {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
