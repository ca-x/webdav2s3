...
func (_c *UserCreate) SetIsEnabled(v bool) *UserCreate {
	_c.mutation.SetIsEnabled(v)
	return _c
}

// SetNillableIsEnabled sets the "is_enabled" field if the given value is not nil.
func (_c *UserCreate) SetNillableIsEnabled(v *bool) *UserCreate {
	if v != nil {
		_c.SetIsEnabled(*v)
	}
	return _c
...
func (_c *UserCreate) AddBackends(v ...*S3Backend) *UserCreate {
	ids := make([]int, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
